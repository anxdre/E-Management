...
import { CircleUser, Menu, UsersRound, UserRound, HandCoins, Scale, MapPinHouse, UserCheck, TabletSmartphone } from "lucide-vue-next";
...
<!--                    </ul>-->
        ...
        <div class="inline-flex h-fit">
            <Popover>
                ...
                <PopoverContent class="space-y-2 px-0 py-1 w-fit">
                    ...
                    <ul>
                        <Button @click="navigateLink(route('device-management.index', { user: $attrs.auth.user?.id }))"
                            variant="ghost" class="hover:text-foreground gap-2 justify-start w-full rounded">
    ...
    <div v-if="$attrs.auth?.user != undefined || null"
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem @click="()=>{navigateLink(route('employee-account.detail',{id:$attrs.auth?.user.id}))}">Settings</DropdownMenuItem>
    ...
    <div v-else class="flex flex-row w-full items-center justify-end gap-4 md:ml-auto md:gap-2 lg:gap-4">
