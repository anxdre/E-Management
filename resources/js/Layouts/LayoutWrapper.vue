...
<template>
    ...
    <div class="flex min-h-screen w-full flex-col relative">
        <Toaster/>
        <div class="flex-col flex sticky top-0 z-10">
            ...
            <div v-if="$attrs.auth?.user && $attrs.auth?.user.email === 'admin@teamway.com'"
                 ...
                 <span @click="()=>{navigateLink(route('company-settings.index'))}" class="italic underline cursor-pointer">Configure Now</span>
            </div>
        </div>
