            ...
            <Card class="xl:col-span-2">
                <CardHeader class="flex flex-row items-center">
                    <div class="grid gap-2">
                        ...
                        <CardDescription>
                            Recent Salary Transactions from your company.
                        </CardDescription>
                    </div>
                    <Button as-child size="sm" class="ml-auto gap-1 bg-black">
                        <a href="#">
                            View All
